package com.learn_everyday.webflux_learning.chapter4;
...
@SpringBootTest(properties = "chapter4")
public class CustomerServiceTest {
    ...
    public void invalidInput() {
        ...
        this.webTestClient.post()
                .uri("/customers")
                .bodyValue(new CustomerDto(null, null, "jane@gmail.com"))
                .exchange()
                .expectStatus().is4xxClientError()
                .expectBody()
        ...
        this.webTestClient.post()
                .uri("/customers")
                .bodyValue(new CustomerDto(null, "jane", null))
                .exchange()
                .expectStatus().is4xxClientError()
                .expectBody()
        ...
        this.webTestClient.put()
                .uri("/customers/10")
                .bodyValue(new CustomerDto(null, "jane", "jane"))
                .exchange()
                .expectStatus().is4xxClientError()
                .expectBody()
                .jsonPath("$.detail").isEqualTo("Email is required");
